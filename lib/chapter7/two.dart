...
class Chapter72 extends StatelessWidget {
  const Chapter72({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ValueListenableRoute(title: '按需rebuild'),
    );
  }
}
...
class _ValueListenableState extends State<ValueListenableRoute> {
  ...
  Widget build(BuildContext context) {
    ...
    print('build');
    return Scaffold(
      appBar: AppBar(title: Text('按需rebuild')),
      body: Center(
